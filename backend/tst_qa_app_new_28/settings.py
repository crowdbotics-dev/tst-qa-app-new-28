"""
Django settings for tst_qa_app_new_28 project.
...
ROOT_URLCONF = 'tst_qa_app_new_28.urls'
...
WSGI_APPLICATION = 'tst_qa_app_new_28.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tst_qa_app_new_28 API",
    "DESCRIPTION": "API documentation for tst_qa_app_new_28 App",
    "VERSION": "v1",
}
